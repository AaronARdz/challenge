...
class Zipcode(models.Model):
    zip_code = models.CharField(max_length=250, null=False) # d_codigo
    ...
    settlement_code = models.CharField(max_length=20, null=True) # id_asenta_cpcons
    zone_type = models.CharField(max_length=20, null=True) # d_zona
    municipality = models.CharField(max_length=20, null=True) #d mnpio
    municipality_code = models.CharField(max_length=20, null=True)  # c mnpio
    federal_entity = models.CharField(max_length=50, null=True) #d_estado
    federal_entity_key = models.CharField(max_length=50, null=True) # c_estado
    federal_entity_code = models.CharField(max_length=50, null=True) # c_ CP
